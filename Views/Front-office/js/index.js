...
async function main() {
  ...
  const myAccountKey = process.env.MY_PRIVATE_KEY;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector("#publickey").value = metadataString;
  });
  ...
  //Mint NFT2
  const metadata2String = "Med File 1";
